<template>
  <div id="app">
    ...
    <h3 id="time-select-options">Time Select Options</h3>
    <table>
      <thead>
        <tr>
          <th>参数</th>
    ...
    <h3 id="time-picker-options">Time Picker Options</h3>
    <table>
      <thead>
        <tr>
          <th>参数</th>
      ...
      <tbody>
        <tr>
          ...
          <td>
            可选时间段，例如<code>'18:30:00 - 20:30:00'</code>或者传入数组<code
              >['09:30:00 - 12:00:00', '14:30:00 - 18:30:00']</code
            >
          </td>
          <td>string / array</td>
          <td>—</td>
